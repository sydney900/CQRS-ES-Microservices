...
import { Observable, Rx } from 'rxjs/Rx';
...
export const KafkaManager = KafkaManager;
export const CommandSender = CommandSender;
export const KafkaConsumer = KafkaConsumer;
